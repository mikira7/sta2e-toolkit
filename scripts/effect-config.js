  ...
  return [
    ...
    },
    {
      ...
      rows: [
        ...
        { label: "Warp — Cardassian Rift Size", slot: "", sndKey: null, animKey: null,
          delayKey: "warpCardassianRiftScale", unit: "%", step: 5,
          defaultHint: "Default: 100% — scales the Cardassian Temporal Rift animation, independently of the Federation rift above." },
        { label: "Warp — Cardassian Rift Peak", slot: "ms", sndKey: null, animKey: null,
          delayKey: "warpCardassianRiftPeakMs", step: 100,
          defaultHint: "Default: 2500 ms — the moment the Cardassian rift is widest. Used automatically by timeships the toolkit reads as Cardassian, in place of the Temporal Rift above. Keep it shorter than the clip." },
        { label: "Warp — Cardassian Rift Sound", slot: "", sndKey: "sndCardassianTemporalRift", animKey: null,
          defaultHint: "Played at both ends of a Cardassian rift transit. Blank falls back to the Warp Depart / Warp Arrive sounds above." },
