...
- **NPC & Player Roller** — Simple-LCARS-styled dice roller with Threat spending and reroll support with auto theat and momentum spending, and reroll functions. Drag and drag, double click or use the easy fill slider to add/spend momentum or threat to build the dice pool.
